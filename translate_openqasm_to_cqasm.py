...
def translate(path):
    ...
    circuit = qiskit.compiler.transpile(circuit, basis_gates=['id', 'ry', 'rx','rz', "x",'y','z','cx','cz']) # Modify if needed
    ...
    for instruction in circuit.data:
        ...
        if gate_name == "h":
            ...
            result += f"x {joined_formatted_qubit_args}\n"
        elif gate_name == "y":
            result += f"y {joined_formatted_qubit_args}\n"
        elif gate_name == "z":
            result += f"z {joined_formatted_qubit_args}\n"
        elif gate_name ==  "id":
            continue
        elif gate_name ==  "cx":
...
if __name__ == '__main__':
    ...
    input_base_path = Path("C:/Users/mbandic/Desktop/PhD/Code/KetGPT/generated_qasm_files/")  # Replace with your input directory
    output_base_path = Path("C:/Users/mbandic/Desktop/PhD/Code/KetGPT/generated_qasm_files_cqasm_new/")  # Replace with your output directory
